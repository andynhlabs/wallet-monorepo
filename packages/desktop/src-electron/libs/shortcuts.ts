...
import type { ExplorerShortcutEvents } from '@mywallet/shared/src/shortcuts/shortcuts.enum';
import { getShortcutsMap } from '@mywallet/shared/src/shortcuts/shortcuts.enum';
