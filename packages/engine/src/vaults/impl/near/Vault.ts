...
import { NearCli } from '@mywallet/blockchain-libs/src/provider/chains/near';
import type { Provider as NearProvider } from '@mywallet/blockchain-libs/src/provider/chains/near';
import type { NearAccessKey } from '@mywallet/blockchain-libs/src/provider/chains/near/nearcli';
